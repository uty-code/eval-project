...
drop table if exists evaluation_grade_ratios_51;
...
create table evaluation_grade_ratios_51
(
    ratio_id bigint identity(1,1) primary key,
    period_id bigint not null,
    dept_id bigint,
    grade_s_ratio int not null default 10,
    grade_a_ratio int not null default 20,
    grade_b_ratio int not null default 40,
    grade_c_ratio int not null default 20,
    grade_d_ratio int not null default 10,
    is_deleted char(1) default 'n',
    version int default 0,
    created_at datetime default getdate(),
    created_by bigint,
