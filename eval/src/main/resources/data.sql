...
values
    ('ROLE_ADMIN', N'시스템 관리자', 'n', 0, getdate(), 1);

insert into roles
    (role_name, description, is_deleted, version, created_at, created_by)
values
    ('ROLE_MANAGER', N'부서 관리자', 'n', 0, getdate(), 1);

insert into roles
    (role_name, description, is_deleted, version, created_at, created_by)
values
    ('ROLE_USER', N'일반 사용자', 'n', 0, getdate(), 1);
...
values
    (2026, N'2026년 상반기 평가', 'IN_PROGRESS', '2026-04-01', '2026-06-30', 'n', 0, getdate(), 1);

insert into evaluation_periods
    (period_year, period_name, status_code, start_date, end_date, is_deleted, version, created_at, created_by)
values
    (2026, N'2026년 하반기 평가', 'PLANNED', '2026-07-01', '2026-12-31', 'n', 0, getdate(), 1);

insert into evaluation_periods
    (period_year, period_name, status_code, start_date, end_date, is_deleted, version, created_at, created_by)
values
    (2025, N'2025년 하반기 평가', 'COMPLETED', '2025-07-01', '2025-12-31', 'n', 0, getdate(), 1);
